	...
	public void processPacket(Client c, int packetType, int packetSize){
		 ...
		 **/
			...
			case FIRST_CLICK:
				...
				distance = c.npcType == 494 || c.npcType == 495 ? 2 : 1;
				if(c.goodDistance(NPCHandler.npcs[c.npcClickIndex].getX(), NPCHandler.npcs[c.npcClickIndex].getY(), c.getX(), c.getY(), distance)){
